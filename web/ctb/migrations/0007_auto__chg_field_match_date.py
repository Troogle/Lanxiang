...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'ctb_match', 'date', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Match.date'
        db.alter_column(u'ctb_match', 'date', self.gf('django.db.models.fields.IntegerField')())
