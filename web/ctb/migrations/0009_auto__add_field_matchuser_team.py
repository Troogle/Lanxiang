...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MatchUser.team'
        db.add_column(u'ctb_matchuser', 'team',
                      self.gf('django.db.models.fields.IntegerField')(default=-1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MatchUser.team'
        db.delete_column(u'ctb_matchuser', 'team')
    ...
    models = {
        ...
        u'ctb.matchuser': {
            ...
            'team': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
